...
class AcceptedInterestsScreen extends StatefulWidget {
  const AcceptedInterestsScreen({super.key});

  @override
  State<AcceptedInterestsScreen> createState() =>
      _AcceptedInterestsScreenState();
}

class _AcceptedInterestsScreenState extends State<AcceptedInterestsScreen> {
  @override
